...
public class VisualizeSpecies {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Input in = new Input(new FileInputStream("generations/50_population.pd"));
        @SuppressWarnings("unchecked")
        PopulationData<NEATGenome> populationData = (PopulationData<NEATGenome>) kryo.readClassAndObject(in);
        in.close();

        SpeciesVisualization.startVisualization(populationData.getTruncatedPopulation(), new NEATSpeciator(), 50);
    }
}
